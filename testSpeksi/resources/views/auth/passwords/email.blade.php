    ...
    <div class="reset-container">
        ...
        @if (session('status'))
            <div class="alert-success">
                {{ session('status') === 'We have emailed your password reset link.' ? 'Kami telah menghantar pautan set semula kata laluan melalui e-mel.' : session('status') }}
            </div>
        @endif
            ...
            <div class="form-group">
                ...
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message === "We can't find a user with that email address." ? 'Kami tidak dapat mencari pengguna dengan alamat e-mel tersebut.' : $message }}</strong>
                    </span>
                @enderror
            </div>
