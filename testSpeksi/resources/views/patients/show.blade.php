...
<body>
  ...
  <div class="container">
    ...
    <div class="section-card">
      ...
      <div class="form-group"><label>Nama Agensi</label><span class="static-field">{{ $patient->agensi ?? '-' }}</span>
      </div>
      <div class="form-group"><label>Nama Pembekal</label><span
          class="static-field">{{ $patient->pembekal ?? '-' }}</span></div>
      ...
      <div class="form-group"><label>Tanggungan Pesakit (RM)</label><span
          class="static-field">{{ $patient->tanggungan ?? '-' }}</span></div>
      <div class="form-group"><label>Jumlah Dipohon (RM)</label><span
          class="static-field">{{ $patient->jumlah_dipohon ?? '-' }}</span></div>
      <div class="form-group"><label>Jumlah Kelulusan (RM)</label><span
          class="static-field">{{ $patient->jumlah_kelulusan ?? '-' }}</span></div>
    ...
    <div class="section-card">
      ...
      <div class="form-group"><label>Masa Temu Janji</label><span
          class="static-field">{{ $patient->masa_temu ? \Carbon\Carbon::parse($patient->masa_temu)->format('h:i A') : '-' }}</span>
      </div>
    ...
    <div class="action-buttons">
      <a class="action-button back" href="{{ route('patients.history', ['no_kp' => $patient->no_kp]) }}" <i
        class="fas fa-arrow-left"></i> Kembali
      </a>
      <a class="action-button print" href="{{ route('patients.letter', $patient->id) }}" target="_blank" <i
        class="fas fa-print"></i> Cetak Surat
      </a>
    </div>
  </div>
</body>
