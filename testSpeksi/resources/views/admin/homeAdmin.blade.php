...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/homeAdmin.css') }}?v={{ time() }}">
...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="action-buttons">
            <a href="{{ route('admin.registerUser') }}" class="btn-register">
    ...
    <script src="{{ asset('js/homeAdmin.js') }}?v={{ time() }}"></script>
</body>
