...
<body>
  ...
  <div class="container">
    ...
    <div class="section-card">
      ...
      <div class="form-group"><label>Agensi</label><span class="static-field">{{ $patient->agensi ?? '-' }}</span></div>
    ...
    <div class="section-card">
      ...
      <div class="form-group"><label>Masa Temu Janji</label><span
          class="static-field">{{ $patient->masa_temu ?? '-' }}</span></div>
    ...
    <div class="action-buttons">
      ...
      <a class="action-button edit" href="{{ route('patients.create', ['kp' => $patient->no_kp]) }}"
