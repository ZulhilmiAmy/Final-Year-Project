    ...
    <div class="container">
        ...
        <form id="patientForm" method="POST" action="{{ route('patients.update', $patient->id) }}"
                ...
                <div class="form-section">
                    ...
                    <div class="checkbox-group">
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]"
                                value="Pembiayaan Peralatan Perubatan" {{ in_array('Pembiayaan Peralatan Perubatan', (array) $bantuan) ? 'checked' : '' }}> Pembiayaan Peralatan Perubatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]"
                                value="Bantuan Pembiayaan Rawatan" {{ in_array('Bantuan Pembiayaan Rawatan', (array) $bantuan) ? 'checked' : '' }}> Bantuan Pembiayaan Rawatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]"
                                value="Bantuan Pembiayaan Ubat-Ubatan" {{ in_array('Bantuan Pembiayaan Ubat-Ubatan', (array) $bantuan) ? 'checked' : '' }}> Bantuan Pembiayaan Ubat-Ubatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Bantuan Am"
                                {{ in_array('Bantuan Am', (array) $bantuan) ? 'checked' : '' }}> Bantuan Am</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]"
                                value="Penempatan Institusi" {{ in_array('Penempatan Institusi', (array) $bantuan) ? 'checked' : '' }}> Penempatan Institusi</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]"
                                value="Mengesan Waris" {{ in_array('Mengesan Waris', (array) $bantuan) ? 'checked' : '' }}> Mengesan Waris</label>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="checkbox-group">
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]"
                                value="Khidmat Perundingan" {{ in_array('Khidmat Perundingan', (array) $terapi) ? 'checked' : '' }}> Khidmat Perundingan</label>
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]"
                                value="Sokongan Emosi" {{ in_array('Sokongan Emosi', (array) $terapi) ? 'checked' : '' }}> Sokongan Emosi</label>
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]"
                                value="Intervensi Krisis" {{ in_array('Intervensi Krisis', (array) $terapi) ? 'checked' : '' }}> Intervensi Krisis</label>
                    </div>
                </div>
            ...
            <div class="compartment" id="compartment3">
                ...
                <div class="checkbox-group">
                    <label><input type="checkbox" name="kategori_kes[]" value="Penyakit Kronik" {{ in_array('Penyakit Kronik', (array) $kategori) ? 'checked' : '' }}> Penyakit Kronik</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Penderaan Kanak-kanak" {{ in_array('Penderaan Kanak-kanak', (array) $kategori) ? 'checked' : '' }}> Penderaan
                        Kanak-kanak</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Keganasan Rumah Tangga" {{ in_array('Keganasan Rumah Tangga', (array) $kategori) ? 'checked' : '' }}> Keganasan Rumah
                        Tangga</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Ibu Tanpa Nikah" {{ in_array('Ibu Tanpa Nikah', (array) $kategori) ? 'checked' : '' }}> Ibu Tanpa Nikah</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Keganasan Seksual" {{ in_array('Keganasan Seksual', (array) $kategori) ? 'checked' : '' }}> Keganasan Seksual</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Pesakit Terdampar" {{ in_array('Pesakit Terdampar', (array) $kategori) ? 'checked' : '' }}> Pesakit Terdampar</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Masalah Tingkah Laku" {{ in_array('Masalah Tingkah Laku', (array) $kategori) ? 'checked' : '' }}> Masalah Tingkah
                        Laku</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="HIV POSITIF / AIDS" {{ in_array('HIV POSITIF / AIDS', (array) $kategori) ? 'checked' : '' }}> HIV POSITIF / AIDS</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Dadah / Alkohol" {{ in_array('Dadah / Alkohol', (array) $kategori) ? 'checked' : '' }}> Dadah / Alkohol</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="Cubaan Bunuh Diri" {{ in_array('Cubaan Bunuh Diri', (array) $kategori) ? 'checked' : '' }}> Cubaan Bunuh Diri</label>
                    <label><input type="checkbox" name="kategori_kes[]" value="OKU" {{ in_array('OKU', (array) $kategori) ? 'checked' : '' }}> OKU</label>
                </div>

                <div class="form-group">
                    <label><input type="checkbox" id="lainCheck" onclick="toggleLainTextbox()" {{ $patient->lain_lain || old('lain_lain') ? 'checked' : '' }}> Lain-lain</label>
                    <input id="lain" name="lain_lain" type="text" value="{{ old('lain_lain', $patient->lain_lain) }}"
                        style="display:{{ old('lain_lain', $patient->lain_lain) ? 'block' : 'none' }}; margin-top:5px;">
                </div>
