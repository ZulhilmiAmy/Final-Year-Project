...
<head>
    ...
    <style>
        ...
        #notif {
            ...
            transform: translateX(-50%); /* Mengkompensasi ukuran elemen */
            background: #4CAF50;
            color: white;
            padding: 15px 25px;
            border-radius: 8px;
...
<body>
    ...
    <!-- HEADER SECTION -->
    <div class="header">
        <img src="https://raw.githubusercontent.com/ZulhilmiAmy/Final-Year-Project/main/Image%20banner/Banner-SPeKSi.png" alt="Banner">
    </div>
    ...
    <div class="container">
        ...
        <!-- MAIN FORM -->
        <form id="patientForm" method="POST" action="{{ route('patients.store') }}" enctype="multipart/form-data" onsubmit="return validateFinal()">
            @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                <label>No. KP</label>
                                <input id="nokp" name="no_kp" maxlength="12" value="{{ request('kp') }}" placeholder="Cth: 010203101234" oninput="autoTarikhUmur()" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" id="agamaLain" name="agama_lain" placeholder="Sila nyatakan" style="display:none; margin-top:5px;">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" id="bangsaLain" name="bangsa_lain" placeholder="Sila nyatakan" style="display:none; margin-top:5px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea id="alamat" name="alamat" rows="2" placeholder="Alamat Jalan / Taman / No Rumah" required></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
            ...
            <div class="compartment" id="compartment2">
                ...
                <div class="form-section">
                    ...
                    <div class="checkbox-group" id="bantuan-praktik-group">
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Pembiayaan Peralatan Perubatan"> Pembiayaan Peralatan Perubatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Bantuan Pembiayaan Rawatan"> Bantuan Pembiayaan Rawatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Bantuan Pembiayaan Ubat-Ubatan"> Bantuan Pembiayaan Ubat-Ubatan</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Bantuan Am"> Bantuan Am</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Penempatan Institusi"> Penempatan Institusi</label>
                        <label><input type="checkbox" class="bantuanpraktik" name="bantuan_praktik[]" value="Mengesan Waris"> Mengesan Waris</label>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="checkbox-group" id="terapi-sokongan-group">
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]" value="Khidmat Perundingan"> Khidmat Perundingan</label>
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]" value="Sokongan Emosi"> Sokongan Emosi</label>
                        <label><input type="checkbox" class="terapisokongan" name="terapi_sokongan[]" value="Intervensi Krisis"> Intervensi Krisis</label>
                    </div>
                </div>
            ...
            <div class="compartment" id="compartment3">
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="checkbox-group">
                            <label><input type="checkbox" name="kategori_kes[]" value="Penyakit Kronik"> Penyakit Kronik</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Penderaan Kanak-kanak"> Penderaan Kanak-kanak</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Keganasan Rumah Tangga"> Keganasan Rumah Tangga</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Ibu Tanpa Nikah"> Ibu Tanpa Nikah</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Keganasan Seksual"> Keganasan Seksual</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Pesakit Terdampar"> Pesakit Terdampar</label>
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="checkbox-group">
                            <label><input type="checkbox" name="kategori_kes[]" value="Masalah Tingkah Laku"> Masalah Tingkah Laku</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="HIV POSITIF / AIDS"> HIV POSITIF / AIDS</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Dadah / Alkohol"> Dadah / Alkohol</label>
                            <label><input type="checkbox" name="kategori_kes[]" value="Cubaan Bunuh Diri"> Cubaan Bunuh Diri</label>
                ...
                <div class="form-group">
                    ...
                    <input id="lain" name="lain_lain" type="text" placeholder="Sila nyatakan" style="display:none; margin-top:5px;">
                </div>
            ...
            <div class="compartment" id="compartment5">
                ...
                <div id="user-readonly-note" class="readonly-tab-note" style="display: none;">
                    <strong>Nota:</strong> Anda adalah pengguna biasa. Bahagian ini hanya untuk dilihat sahaja dan tidak boleh diisi.
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="date" id="tarikhdoklengkap" name="tarikh_dokumen_lengkap" class="user-restricted-field">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="tanggung" name="tanggungan" step="0.01" class="user-restricted-field">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label>Jumlah Dipohon (RM)</label>
                            <input type="number" id="dipohon" name="jumlah_dipohon" step="0.01" class="user-restricted-field">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label>Jumlah Kelulusan (RM)</label>
                            <input type="number" id="lulus" name="jumlah_kelulusan" step="0.01" class="user-restricted-field">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="date" id="tarikhtuntut" name="tarikh_tuntut" class="small-date-input user-restricted-field">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="file-upload">
                        ...
                        <input type="file" id="dokumen" name="dokumen_sokongan" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" class="user-restricted-field">
            ...
            <div class="compartment" id="compartment6">
                ...
                <div class="form-group">
                    ...
                    <textarea id="catatantemujanji" name="catatan_temu" rows="3" placeholder="Catatan tambahan untuk temu janji"></textarea>
                </div>
    ...
    <script>
        ...
        let data = {};
        let calendar;
        let isRegularUser = true; // Tetapkan ini berdasarkan jenis user sebenarnya
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (calendarEl) {
                calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    locale: 'ms',
                    headerToolbar: {
                        left: 'prev,next',  // Hanya butang sebelumnya dan seterusnya
                        center: 'title',
                    },
                    events: @json($events),
        ...
        function simpan(num, showNotif = true) {
            ...
            if (isRegularUser && num === 5) {
                if (showNotif) {
                    ...
                    notif.innerText = "Anda tidak mempunyai kebenaran untuk menyimpan data di bahagian ini.";
