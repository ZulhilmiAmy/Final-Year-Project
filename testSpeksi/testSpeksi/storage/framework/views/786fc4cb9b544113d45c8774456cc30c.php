...
<body>
    <div class="reset-container">
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>" id="passwordResetForm">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\testSpeksi\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>