...
<head>
  ...
  <script>
    window.patientsSearchUrl = "<?php echo e(route('patients.search')); ?>";
    window.patientsHistoryUrl = "<?php echo e(route('patients.history')); ?>";
    window.patientsCreateUrl = "<?php echo e(route('patients.create')); ?>";
    window.appointmentsUpcomingUrl = "<?php echo e(route('appointments.upcoming')); ?>";
  </script>
...
<body>
  ...
  <div class="top-bar">
    <div class="breadcrumbs">
      <a href="#" onclick="confirmGoLogin('<?php echo e(route('login.custom')); ?>')">Log Masuk</a> &gt;
      <a>Halaman Utama</a>
    </div>
...
<?php if(session('pdf_url')): ?>
  <a id="autoPdfLink" href="<?php echo e(session('pdf_url')); ?>" target="_blank" style="display:none;"></a>
  <script>
...
<script>
  function newApplication() {
    ...
    window.location.href = "<?php echo e(route('patients.create')); ?>?kp=" + encodeURIComponent(kp);
  }
</script>


</html><?php /**PATH C:\laragon\www\testSpeksi\resources\views/home.blade.php ENDPATH**/ ?>