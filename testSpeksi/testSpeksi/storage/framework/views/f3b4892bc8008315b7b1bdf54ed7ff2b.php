...
<body>
    ...
    <div class="top-bar">
        <div class="breadcrumbs">
            <a>Login</a> &gt;
            <a href="<?php echo e(route('home')); ?>" onclick="return confirmHome(event)">Halaman Utama</a> &gt;
    ...
    <div class="container">
        ...
        <!-- MAIN FORM -->
        <form id="patientForm" method="POST" action="<?php echo e(route('patients.store')); ?>" enctype="multipart/form-data" onsubmit="return validateFinal()">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                <label>No. KP</label>
                                <input id="nokp" name="no_kp" maxlength="12" value="<?php echo e(request('kp')); ?>" placeholder="Cth: 010203101234" oninput="autoTarikhUmur()" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="tanggung" name="tanggungan" min=1 step="1.00">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label>Jumlah Dipohon (RM)</label>
                            <input type="number" id="dipohon" name="jumlah_dipohon" min=1 step="1.00">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label>Jumlah Kelulusan (RM)</label>
                            <input type="number" id="lulus" name="jumlah_kelulusan" min=1 step="1.00">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function confirmGoLogin() {
            if (confirm("Adakah anda pasti mahu kembali ke halaman Login?")) {
                window.location.href = "<?php echo e(route('login.custom')); ?>";
            }
        }
...
</html><?php /**PATH C:\laragon\www\testSpeksi\resources\views/patients/create.blade.php ENDPATH**/ ?>